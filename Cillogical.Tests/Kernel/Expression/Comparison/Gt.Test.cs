...
public class GtTest
{
    ...
    {
        // Truthy
        yield return [new Value(2), new Value(1), true];
        yield return [new Value(1.2), new Value(1.1), true];
        yield return [new Value(1.2f), new Value(1.1f), true];
        // Falsy
        ...
        yield return [new Value(1.0f), new Value(1.1f), false];
        yield return [new Value(1), new Value("1"), false];
