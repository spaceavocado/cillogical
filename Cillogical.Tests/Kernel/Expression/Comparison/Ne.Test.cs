...
public class NeTest
{
    ...
    {
        // Truthy
        yield return new object[] { new Value(1), new Value(1.1), true };
        yield return new object[] { new Value(1), new Value("1"), true };
        yield return new object[] { new Value(1), new Value(true), true };
        yield return new object[] { new Value(1.1), new Value("1"), true };
        yield return new object[] { new Value(1.1), new Value(true), true };
        yield return new object[] { new Value("1"), new Value(true), true };
        yield return new object[] { new Value(null), new Value(1), true };
        yield return new object[] { new Value(1), new Value(null), true };
        ...
        yield return new object[] { new Value("1"), new Value("1"), false };
        yield return new object[] { new Value(true), new Value(true), false };
        yield return new object[] { new Value(false), new Value(false), false };
