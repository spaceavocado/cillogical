...
public class XorTest
{
    ...
    {
        // Truthy
        yield return [new IEvaluable[] { new Value(true), new Value(false) }, true];
        yield return [new IEvaluable[] { new Value(false), new Value(true) }, true];
        yield return [new IEvaluable[] { new Value(true), new Value(false), new Value(false) }, true];
        yield return [new IEvaluable[] { new Value(false), new Value(true), new Value(false) }, true];
        yield return [new IEvaluable[] { new Value(false), new Value(false), new Value(true) }, true];
        // Falsy
        ...
        yield return [new IEvaluable[] { new Value(true), new Value(false), new Value(true) }, false];
        yield return [new IEvaluable[] { new Value(true), new Value(true), new Value(true) }, false];
    }
    ...
    public static IEnumerable<object[]> SimplifyTestData()
    {
        ...
        yield return [new IEvaluable[] { new Value(false), new Value(false) }, false];
        yield return [new IEvaluable[] { new Value(true), new Value(true) }, false];
        yield return [new IEvaluable[] { new Value(true), new Value(true), new Value(1) }, false];
        ...
        yield return [new IEvaluable[] { new Reference("Missing"), new Value(true) }, new Not(new Reference("Missing"))];
        yield return [
        ...
        yield return [
            ...
            new Xor([new Reference("Missing"), new Reference("Missing")])
        ];
        yield return [new IEvaluable[] { new Value(false), new Reference("invalid") }, new Reference("invalid")];
    }
